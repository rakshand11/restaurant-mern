    ...
    <div className="min-h-screen bg-[#0a0a0a]" style={{ fontFamily: "'Montserrat', sans-serif" }}>
      ...
      <div className="flex items-center justify-center min-h-screen px-4 py-12">
        <div style={{
          ...
          <h1 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.75rem", fontWeight: 300, color: "#f5ead6", margin: "0 auto 1.5rem", textAlign: "center" }}>
            Create Your <em style={{ color: "#c9a55a" }}>Account</em>
          </h1>

          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            <div style={{ position: "relative" }}>
              <User2 className="absolute left-3 top-1/2 -translate-y-1/2" style={{ color: "#b8965a" }} size={18} />
          ...
          <p style={{ fontSize: 11, letterSpacing: "0.1em", color: "#8a7e68", marginTop: "1rem", textAlign: "center" }}>
            ...
            <Link to="/login" style={{ color: "#b8965a", fontWeight: 500, textDecoration: "underline" }}>Log In</Link>
          </p>
        </div>
      </div>
    </div>
